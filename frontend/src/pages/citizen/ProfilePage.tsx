        ...
        <Card hover={false}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Textarea
              ...
              {...register('address')}
            />
            <div className="flex items-center gap-2 rounded-xl bg-slate-50 px-3 py-2 text-sm text-slate-500 dark:bg-slate-800/50">
              <MapPin className="h-4 w-4 shrink-0" />
              Email cannot be changed here ({user.email})
            </div>
            <Button
              type="submit"

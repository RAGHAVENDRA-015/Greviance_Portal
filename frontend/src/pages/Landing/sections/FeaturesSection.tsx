        ...
        >
          {features.map(({ icon: Icon, title, description }) => (
            <motion.article
              ...
              variants={item}
              whileHover={{ y: -4 }}
              className="glass rounded-2xl p-6 transition-shadow hover:shadow-xl"
            >
              <div className="flex h-11 w-11 items-center justify-center rounded-xl gradient-primary text-white shadow-lg shadow-primary-500/25">

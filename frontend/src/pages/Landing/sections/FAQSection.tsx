          ...
          {faqs.map((faq, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="font-heading text-sm font-semibold sm:text-base">{faq.q}</span>
                  <ChevronDown
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <p className="border-t border-slate-200/60 px-5 pb-4 pt-3 text-sm leading-relaxed text-slate-600 dark:border-slate-700/60 dark:text-slate-300">
                        {faq.a}
                      </p>
                    </motion.div>
                  )}

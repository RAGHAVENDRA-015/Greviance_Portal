...
export default function ForgotPasswordPage() {
  ...
  return (
    ...
    >
      ...
      <h2 className="font-display text-xl sm:text-2xl font-extrabold">Reset password</h2>
      <p className="mt-1 text-xs sm:text-sm text-slate-500">We will email you a secure reset link</p>

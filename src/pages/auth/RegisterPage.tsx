...
export default function RegisterPage() {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-md rounded-2xl sm:rounded-3xl glass-strong p-5 sm:p-8 md:p-10 shadow-2xl"
    >
      <Link to="/" className="mb-5 sm:mb-6 inline-flex items-center gap-2 font-heading text-base sm:text-lg font-bold">
        <span className="flex h-8 w-8 items-center justify-center rounded-lg gradient-primary text-sm text-white">G</span>
        {APP_NAME}
      </Link>
      <h2 className="font-display text-xl sm:text-2xl font-extrabold">Create your account</h2>
      <p className="mt-1 text-xs sm:text-sm text-slate-500">Join the smart civic grievance network</p>

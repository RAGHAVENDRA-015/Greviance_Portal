...
export default function ComplaintsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="font-display text-xl sm:text-2xl font-extrabold">All Complaints</h1>
        <p className="mt-0.5 sm:mt-1 text-xs sm:text-sm text-slate-500">Assign officers, filter, and manage records</p>
      </div>
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <select
              ...
              className="h-10 sm:h-11 flex-1 min-w-0 rounded-xl border border-slate-200 bg-white/80 px-2.5 sm:px-3 text-xs sm:text-sm outline-none focus:border-primary-500 dark:border-slate-700 dark:bg-slate-900/80"
            >

      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0 flex-1">
            ...
            <h1 className="break-words font-display text-xl sm:text-2xl lg:text-3xl font-extrabold text-slate-900 dark:text-white">
              {complaint.title}
            </h1>
          ...
          <Link to={ROUTES.citizen.complaints} className="w-full sm:w-auto">
            <Button variant="outline" size="sm" leftIcon={<ArrowLeft className="h-4 w-4" />} className="w-full sm:w-auto">
              Back
            </Button>
          </Link>
        </div>

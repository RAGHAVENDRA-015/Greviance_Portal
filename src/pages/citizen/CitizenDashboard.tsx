    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col gap-4 sm:gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-xs sm:text-sm font-semibold uppercase tracking-widest text-white/70">Citizen Portal</p>
            <h1 className="mt-1 sm:mt-2 font-display text-2xl sm:text-3xl lg:text-4xl font-extrabold">
              Welcome back, {firstName}
            </h1>
            <p className="mt-1 sm:mt-2 max-w-xl text-xs sm:text-sm md:text-base text-white/85">
              Track your grievances, review AI insights, and file new issues in one place.
            </p>
          </div>
          <div className="flex flex-wrap gap-2.5 sm:gap-3">
            <Link to={ROUTES.citizen.createComplaint} className="flex-1 sm:flex-initial">
              <Button
                leftIcon={<PlusCircle className="h-4 w-4" />}
                className="w-full sm:w-auto bg-white text-primary-700 shadow-none hover:bg-white/90"
              >
                New Complaint
              </Button>
            </Link>
            <Link to={ROUTES.citizen.complaints} className="flex-1 sm:flex-initial">
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <div className="min-w-0 overflow-hidden lg:col-span-2 space-y-6">
          {pieData.length > 0 ? (
        ...
        <Card hover={false} className="min-w-0 flex flex-col items-center justify-center gap-4">
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <div className="min-w-0 overflow-hidden lg:col-span-2 space-y-4">

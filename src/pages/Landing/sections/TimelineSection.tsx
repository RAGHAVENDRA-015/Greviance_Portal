    ...
    <section className="py-16 sm:py-24 lg:py-28">
      <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto mt-10 sm:mt-16 max-w-3xl">
          <div className="absolute bottom-0 left-3.5 top-0 w-px bg-gradient-to-b from-primary-400 via-cyan-brand to-emerald-brand sm:left-1/2 sm:-translate-x-px" />
          ...
          <div className="space-y-6 sm:space-y-10">
            {milestones.map((item, i) => {
              ...
              return (
                ...
                >
                  <div className="absolute left-3.5 top-5 z-10 h-3 w-3 -translate-x-1/2 rounded-full gradient-primary ring-4 ring-white dark:ring-slate-900 sm:left-1/2" />
                  <div
                    className={`ml-8 w-full rounded-2xl glass p-4 sm:p-5 sm:ml-0 sm:w-[calc(50%-1.5rem)] ${
                  ...
                  >
                    ...
                    <h3 className="mt-1 font-heading text-base sm:text-lg font-bold">{item.title}</h3>
                    <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-slate-600 dark:text-slate-300">{item.text}</p>
                  </div>
                </motion.div>
              )
            })}

...
export function ContactCTASection() {
  ...
  return (
    <section className="py-16 sm:py-24 lg:py-28" aria-label="Get started">
      <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl gradient-primary px-4 py-10 text-center text-white shadow-2xl shadow-primary-500/30 sm:px-12 sm:py-14"
        >
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-3 sm:mt-4 max-w-xl text-sm sm:text-base text-primary-100">
            ...
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3">
              <Button
                ...
                className="w-full sm:w-auto bg-white text-primary-700 shadow-xl hover:bg-primary-50"
              >
                Create free account
              </Button>
              <Button

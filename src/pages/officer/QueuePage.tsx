  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="font-display text-xl sm:text-2xl font-extrabold">Department Queue</h1>
          <p className="mt-0.5 sm:mt-1 text-xs sm:text-sm text-slate-500">Review and update complaint statuses</p>
        </div>
        <Button
          variant="outline"

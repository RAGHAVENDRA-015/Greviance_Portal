      ...
      >
        ...
        <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="mt-1 sm:mt-2 font-display text-2xl sm:text-3xl lg:text-4xl font-extrabold">Hello, {firstName}</h1>
          ...
          <Link to={ROUTES.officer.queue} className="w-full sm:w-auto">
            <Button className="w-full sm:w-auto bg-white text-primary-700 shadow-none hover:bg-white/90">
              Open queue
            </Button>
          </Link>
        </div>
